            ...
            if(authRes.data.status === 200) {
                ...
                db.executeInsert(req, (err, res) => {
                    if(err) {
                        ...
                        return next(null, { status: res.status, res: res.res[0][0] });
                    }
                });
            } else {
